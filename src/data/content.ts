...
export const HABITS = [
  {id:'walk',n:'Phoneless Walk',icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="3.5" r="2.5" fill="currentColor" opacity=".8"/><path d="M14.5 7h-5L7 13l2.5 1L8 21h2l2-5 2 5h2l-1.5-7 2.5-1L14.5 7z" fill="currentColor" opacity=".7"/><path d="M6 22c1-2 3-3 6-3s5 1 6 3" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" opacity=".3"/></svg>`,dur:'45 min',sub:'Silence. No phone. Let the locus coeruleus relearn slow tonic firing.',cat:'body',neuro:'Walking in silence directly re-trains the brainstem nucleus governing norepinephrine. Digital use forces sharp-burst firing; walking restores slow tonic patterns. Erickson et al. (2011) showed hippocampal volume grows 2% after 1yr of aerobic exercise.',boost:'+25%',deva:'वायु-सेवन',tradeoff:3,mins:45},
  {id:'read',n:'Deep Reading',icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 21V7" stroke="currentColor" stroke-width="1.5"/><path d="M12 7C10 4 6 3 2 4.5V19c4-1.5 8-.5 10 2" fill="currentColor" opacity=".15" stroke="currentColor" stroke-width="1.3"/><path d="M12 7c2-3 6-4 10-2.5V19c-4-1.5-8-.5-10 2" fill="currentColor" opacity=".15" stroke="currentColor" stroke-width="1.3"/><circle cx="7" cy="10" r=".7" fill="currentColor" opacity=".5"/><circle cx="7" cy="13" r=".7" fill="currentColor" opacity=".5"/><circle cx="17" cy="10" r=".7" fill="currentColor" opacity=".5"/><circle cx="17" cy="13" r=".7" fill="currentColor" opacity=".5"/></svg>`,dur:'1 hr',sub:'Real paper book. Uninterrupted. Reactivates left-hemisphere language circuits.',cat:'brain',neuro:'Berns et al. (2013): sustained reading strengthens prefrontal cortex connectivity. Counteracts the 75% visual-over-language neural shift. The Sanskrit Effect (Hartzell, Scientific American 2018) shows text memorisation grows hippocampal grey matter.',boost:'+34%',deva:'स्वाध्याय',tradeoff:4,mins:60},
  {id:'meditation',n:'Silent Meditation',icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="5" r="2.2" fill="currentColor" opacity=".8"/><path d="M8 11c0 0 1.5 2 4 2s4-2 4-2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M6 18c1.5-3 3.5-4.5 6-4.5s4.5 1.5 6 4.5" fill="currentColor" opacity=".2" stroke="currentColor" stroke-width="1.3"/><path d="M4 20h16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><circle cx="12" cy="2" r=".8" fill="currentColor" opacity=".5"/><path d="M9.5 2.5c-.8-1-.5-2 .5-2.5" stroke="currentColor" stroke-width=".8" opacity=".4"/><path d="M14.5 2.5c.8-1 .5-2-.5-2.5" stroke="currentColor" stroke-width=".8" opacity=".4"/></svg>`,dur:'20 min',sub:'Sit. Do nothing. Let the Default Mode Network reboot itself.',cat:'yoga',neuro:'IISc Bangalore (2026): long-term meditators show stronger gamma brain activity and healthier inhibitory circuits. Reignites the DMN — suppressed 80% by digital stimulation. SVYASA fNIRS: yoga reshapes brain microstates within 8 weeks.',boost:'+28%',deva:'ध्यानम्',tradeoff:3,mins:20},
  {id:'pranayama',n:'Pranayama',icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M2 12c2-4 5-5 8-2s6 2 8-2" stroke="currentColor" stroke-width="2" stroke-linecap="round" opacity=".8"/><path d="M2 17c2-4 5-5 8-2s6 2 8-2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity=".4"/><path d="M2 7c2-4 5-5 8-2s6 2 8-2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity=".4"/><circle cx="12" cy="12" r="1.5" fill="currentColor" opacity=".6"/></svg>`,dur:'15 min',sub:'Regulate breath = regulate the entire autonomic nervous system.',cat:'yoga',neuro:'Slow-paced breathing (5–6/min) activates the baroreflex arc, synchronizing HRV with brain oscillations. Stanford research: cortisol drops up to 22%. Directly calms the 88%-shifted amygdala. Modulates parasympathetic response.',boost:'+22%',deva:'प्राणायाम',tradeoff:5,mins:15},
  {id:'namjap',n:'Naam Jap',icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1.2" opacity=".25"/><circle cx="12" cy="12" r="7" stroke="currentColor" stroke-width="1.2" opacity=".35"/><circle cx="12" cy="12" r="4" stroke="currentColor" stroke-width="1.5" opacity=".5"/><circle cx="12" cy="12" r="1.8" fill="currentColor" opacity=".8"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" opacity=".3"/><path d="M4.93 4.93l2.12 2.12M16.95 16.95l2.12 2.12M4.93 19.07l2.12-2.12M16.95 7.05l2.12-2.12" stroke="currentColor" stroke-width=".8" stroke-linecap="round" opacity=".2"/></svg>`,dur:'10 min',sub:'Repetition of the Sacred Name. The oldest cognitive entrainment protocol.',cat:'yoga',neuro:'Sanskrit Effect (Hartzell, Scientific American): reciting mantras increases grey matter in hippocampus and temporal cortex. Rhythmic repetition induces theta-alpha states, restoring dlPFC thickness. Directly targets ACC dominance.',boost:'+20%',deva:'नाम जप',tradeoff:0,mins:10},
  {id:'handwork',n:'Hand Work',icon:`<img src="/hand-work.png" alt="Hand Work" style="width:36px;height:36px;margin:-4px 0 5px -4px;object-fit:cover;mix-blend-mode:lighten"/>`,dur:'20 min',sub:'Cook, fix things, tie knots. Minds were built for hands.',cat:'body',neuro:'Corrects the 70% cognitive-prediction/motor-skill imbalance. SVYASA Psychology Lab confirms motor-cognitive integration. Activating fine motor pathways rebuilds cerebellar-prefrontal connectivity lost to passive consumption.',boost:'+18%',deva:'कर्म योग',tradeoff:6,mins:20},
