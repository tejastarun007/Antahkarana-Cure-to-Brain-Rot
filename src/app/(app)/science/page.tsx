...
export default function Science() {
  ...
  return (
    <div className="screen on" id="sci">
      ...
      <div className="scroll" style={{ flex: 1, paddingBottom: 'calc(80px + env(safe-area-inset-bottom, 0px))' }}>
          ...
          <div className="sci-sec on" style={{ padding: '0 20px', paddingBottom: '20px' }}>
            ...
            <div style={{ position: 'relative', margin: '0 auto 16px', maxWidth: '340px', userSelect: 'none' }}>
              ...
              <svg viewBox="-50 0 600 380" style={{ width: '100%', height: 'auto', position: 'relative', zIndex: 1 }}>
                ...
                <g onClick={() => handleRegionClick('acc')} style={{ cursor: 'pointer' }}>
                ...
                <g onClick={() => handleRegionClick('dmn')} style={{ cursor: 'pointer' }}>
                ...
                <g onClick={() => handleRegionClick('hpc')} style={{ cursor: 'pointer' }}>
                ...
                <g onClick={() => handleRegionClick('amg')} style={{ cursor: 'pointer' }}>
                ...
                <g onClick={() => handleRegionClick('bca')} style={{ cursor: 'pointer' }}>
                ...
                <g onClick={() => handleRegionClick('cbl')} style={{ cursor: 'pointer' }}>
            ...
            {!selectedRegion && (
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '6px', color: 'var(--gold2)' }}>
                  <ClickHand style={{ width: '24px', height: '24px' }} />
                </div>
        ...
        {activeSciTab === 'tradeoffs' && (
          <div className="sci-sec on" style={{ padding: '0 20px', paddingBottom: '20px' }}>
            ...
            {TRADEOFFS.map((t, i) => (
              <div key={i} className="to-item2" style={{ position: 'relative' }} onClick={() => {
                if (!store.hasSeenScienceHint) store.markScienceHintSeen();
