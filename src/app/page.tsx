      ...
      <div className="screens">
        <div className="screen on" id="sg">
          ...
          <div className={`gw-form ${mounted ? 'in' : ''}`}>
            ...
            >
              <span>{loading ? 'Entering...' : mode === 'signup' ? 'Create Account' : 'Begin the Journey'}</span>
            ...
            <div className="social-r">
              ...
              <button className="btn-soc" onClick={() => { document.cookie = "guest_mode=true; path=/; max-age=31536000"; showTransition(); }}>
            ...
            <div className="gw-foot">
              {mode === 'login' ? (
                <>New to this path? <a onClick={() => { setMode('signup'); setError(''); }}>Create account ›</a></>
              ) : (
                <>Already on the path? <a onClick={() => { setMode('login'); setError(''); }}>Sign in ›</a></>
              )}
            </div>
          </div>
        </div>
